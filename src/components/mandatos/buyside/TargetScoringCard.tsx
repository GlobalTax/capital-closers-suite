...
interface TargetScoringCardProps {
...
export function TargetScoringCard({ 
  scoring, 
  matchScore = 0, 
  onSave,
  isSaving = false,
}: TargetScoringCardProps) {
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        ...
        <div className="flex items-center justify-between p-2 rounded-lg bg-muted/30 cursor-pointer hover:bg-muted/50 transition-colors">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <Badge 
                variant="outline" 
                className={cn("text-xs", getScoreColor(scoreTotal))}
              >
                Total: {scoreTotal}%
              </Badge>
              {matchScore > 0 && (
      ...
      <CollapsibleContent>
        <div className="p-4 space-y-4 border-t mt-2">
          {/* Sliders de scoring */}
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                onValueChange={([value]) => setLocalScoring(s => ({ ...s, fit_estrategico: value }))}
                max={100}
                step={5}
                className="w-full"
              />
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                onValueChange={([value]) => setLocalScoring(s => ({ ...s, fit_financiero: value }))}
                max={100}
                step={5}
                className="w-full"
              />
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                onValueChange={([value]) => setLocalScoring(s => ({ ...s, fit_cultural: value }))}
                max={100}
                step={5}
                className="w-full"
              />
