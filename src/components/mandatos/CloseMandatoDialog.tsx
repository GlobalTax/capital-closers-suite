...
export function CloseMandatoDialog({
  ...
  const handleConfirm = () => {
    const data: CloseData = {
      outcome,
      ...(outcome === "won" && { won_value: wonValue }),
      ...(isLossOrCancel && { 
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Cerrar Mandato</DialogTitle>
          <DialogDescription>
            {mandato.empresa_principal?.nombre || mandato.descripcion}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <Label>¿Cómo cerró este mandato?</Label>
            <RadioGroup
              value={outcome}
            ...
            >
              <div>
                ...
                >
                  ...
                  <span className="text-sm font-medium">Ganado</span>
                </Label>
              </div>
              <div>
          ...
          {outcome === "won" && (
            <div className="space-y-4 p-4 bg-green-500/5 border border-green-500/20 rounded-lg">
              <div className="space-y-2">
                <Label htmlFor="won-value">Valor Real de Cierre (€)</Label>
                <Input
                  id="won-value"
                  type="number"
                  placeholder="1500000"
            ...
            <div className="space-y-4 p-4 bg-destructive/5 border border-destructive/20 rounded-lg">
              <div className="space-y-2">
                <Label htmlFor="loss-reason" className="flex items-center gap-2">
                  ¿Por qué se {outcome === "lost" ? "perdió" : "canceló"}?
              ...
              <div className="space-y-2">
                <Label htmlFor="loss-notes">Notas adicionales (opcional)</Label>
                <Textarea
                  id="loss-notes"
                  placeholder="Detalles sobre la pérdida para aprendizaje futuro..."
                  value={lossNotes}
