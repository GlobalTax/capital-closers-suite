...
interface EditarEmpresaDrawerProps {
  open: boolean;
...
export function EditarEmpresaDrawer({ open, onOpenChange, empresa, onEmpresaActualizada }: EditarEmpresaDrawerProps) {
  ...
  const form = useForm<EmpresaFormData>({
    ...
    defaultValues: {
      ...
      revenue: empresa.revenue || undefined,
